            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm">
                  ...
                  {licenses.length} {t("downloads.title")}
                </div>
        ...
        {licenses.length === 0 ? (
          <div className="relative bg-[#111] rounded-xl border border-[#222] p-12 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">{t("downloads.noDownloads")}</h3>
                        ...
                        <div className="flex items-center gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <div className="mt-2 flex flex-wrap gap-2">
                              ...
                              >
                                {isActive ? (
                                  <><CheckCircle className="w-3 h-3 mr-1.5" /> {t("common.active").toUpperCase()}</>
                                ) : license.status === "EXPIRED" ? (
                                  <><XCircle className="w-3 h-3 mr-1.5" /> {t("dashboard.expired").toUpperCase()}</>
                                ) : (
                                  license.status
                                )}
                              </span>
                  ...
                  <div className="p-8">
                    {latestVersion ? (
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <h4 className="text-xl font-bold text-white">
                                {t("downloads.version")} {latestVersion.version}
                              </h4>
                          ...
                          <div className="flex flex-col gap-4 w-full xl:w-[320px]">
                            ...
                            {isActive ? (
                              ...
                              <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 flex items-center gap-3">
                                ...
                                <p className="text-red-300 text-sm font-medium">{t("dashboard.renewLicense")}</p>
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-400">{t("downloads.noVersion")}</p>
                      </div>
                    )}
                    ...
                    {license.product.versions.slice(1).length > 0 && (
                      <details className="mt-8 group">
                        <summary className="cursor-pointer text-gray-400 hover:text-white transition-colors flex items-center gap-2 font-medium select-none">
                          ...
                          <span>Previous {t("downloads.version")}s ({license.product.versions.length - 1})</span>
                        </summary>
                            ...
                            >
                              ...
                              {isActive ? (
                                <a
                                  ...
                                  title={t("downloads.downloadLatest")}
                                  download
                                >
                                  <Download className="w-4 h-4" />
                                </a>
                              ) : (
                                <span className="text-gray-600 text-xs">{t("common.inactive")}</span>
                              )}
                            </div>
                          ))}
                        </div>
