      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 space-y-8 animate-fade-in pb-10">
        {licenses.length === 0 ? (
          <div className="relative bg-[#111] rounded-xl border border-[#222] p-12 text-center overflow-hidden">
            ...
            <div className="relative z-10 w-24 h-24 bg-gray-800/50 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/buy"
                className="inline-flex items-center justify-center gap-2 bg-[#22c55e] text-black hover:bg-[#16a34a] font-bold py-3 px-8 rounded-xl transition-transform hover:scale-105 shadow-lg shadow-[#22c55e]/20"
              >
              ...
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center gap-2 bg-[#111] hover:bg-[#151515] text-white font-medium py-3 px-8 rounded-xl border border-[#222] hover:border-[#22c55e]/50 transition-all"
              >
                Dashboard
              </Link>
            </div>
                           ...
                           <span
                             className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold tracking-wide ${isActive
                                 ...
                                 : license.status === "EXPIRED"
                                   ...
                                   : "bg-gray-700 text-gray-400 border border-[#333]"
                               }`}
                           >
                            {isActive ? (
                        ...
                        {latestVersion.changelog && (
                          <div className="mb-6">
                            <h5 className="text-xs font-bold text-neutral-500 uppercase tracking-wider mb-2">Change Log</h5>
                             <div className="text-sm text-gray-300 leading-relaxed bg-[#111] border border-[#222] rounded-lg p-4 font-mono hover:border-[#22c55e]/30 transition-all">
                               {latestVersion.changelog}
                             </div>
                          </div>
                        )}
