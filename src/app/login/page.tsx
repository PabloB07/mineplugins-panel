        ...
        <div className="bg-[#111] rounded-2xl shadow-2xl p-8 border border-[#222] hover:border-green-500/20 transition-all duration-300">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#22c55e] hover:bg-[#16a34a] text-black rounded-xl transition-all hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 font-semibold shadow-lg hover:shadow-[#22c55e]/25 border border-[#22c55e]/30"
            >
              ...
              {isLoading ? t("login.signingIn") : t("login.continueWithDiscord")}
            </button>

            {/* Additional info */}
            <div className="flex items-center gap-3 my-6">
              <div className="flex-1 h-px bg-[#222]"></div>
              <span className="text-xs text-gray-500 font-medium">{t("login.secure")}</span>
              <div className="flex-1 h-px bg-[#222]"></div>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-[#0a0a0a] rounded-lg border border-[#222]">
            <p className="text-sm text-gray-400 text-center">
              <span className="text-green-400">✓</span> {t("login.benefits.instant")}<br/>
              <span className="text-green-400">✓</span> {t("login.benefits.manage")}<br/>
              <span className="text-green-400">✓</span> {t("login.benefits.updates")}
            </p>
          </div>
