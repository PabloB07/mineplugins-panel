      ...
      <div className="relative max-w-md mx-auto px-4 py-20 w-full z-10">
        ...
        <div className="pixel-frame bg-[#111] rounded-2xl p-6 border border-[#222]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-[#22c55e] hover:bg-[#16a34a] text-black rounded-xl transition-all hover:scale-[1.01] font-semibold"
          >
