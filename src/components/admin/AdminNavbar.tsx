        ...
        <nav className="bg-[#0a0a0a]/90 backdrop-blur-md border-b border-[#f59e0b]/20 sticky top-0 z-50 shadow-lg shadow-black/20">
            <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-[4.5rem]">
                    ...
                    {/* Desktop Navigation */}
                    <div className="hidden xl:flex items-center gap-1 px-2 overflow-x-auto">
                        {navItems.map((item) => {
                            ...
                            return (
                                <Link
                                    key={item.href}
                                    href={item.href}
                                    className={`flex items-center gap-1.5 px-2 py-2 rounded-lg text-xs font-medium transition-all duration-200 group whitespace-nowrap flex-shrink-0 ${active
                        ...
                        <Link
                            href="/dashboard"
                            className="text-blue-400 hover:text-blue-300 px-2 py-2 rounded-lg text-xs font-medium transition-all duration-200 hover:bg-blue-400/10 border border-blue-400/20 hover:border-blue-400/30 whitespace-nowrap flex-shrink-0"
