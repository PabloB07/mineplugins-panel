...
export function convertPrice(dollars: number, fromCurrency: Currency, toCurrency: Currency): number {
  ...
  switch (toCurrency) {
    case 'CLP':
      return dollars * EXCHANGE_RATES.USD_TO_CLP;
    case 'EUR':
      return dollars * EXCHANGE_RATES.USD_TO_EUR;
    case 'CAD':
      return dollars * EXCHANGE_RATES.USD_TO_CAD;
    default:
      return dollars;
  }
}
